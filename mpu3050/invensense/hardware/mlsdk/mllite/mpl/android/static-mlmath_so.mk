...
LINK    += -Wl,-rpath,$(ANDROID_ROOT)/out/target/product/beagleboard/obj/lib:$(ANDROID_ROOT)/out/target/product/beagleboard/system/lib -L$(ML_PLATFORM)/linux -lmlplatform
...
VPATH   += $(ML_DIR) 
VPATH   += $(ML_DIR)/accel $(ML_DIR)/compass $(ML_DIR)/log 
...
ML_SRCS = \
	...
	$(ML_DIR)/accel/lis331_lpp.c \
	$(ML_DIR)/compass/hscdtd002b.c \
